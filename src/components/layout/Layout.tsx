            ...
            {activeNote ? (
              ...
              <div className="h-full flex items-center justify-center">
                <div className="text-center p-8 max-w-md">
                  <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-2">Welcome to OpenbookLM</h2>
                  <p className="text-gray-600 dark:text-gray-300 mb-6">
                    Upload documents or create notes to get started. Use the AI assistant to analyze your content.
                  </p>
                  <div className="flex flex-col space-y-4">
                    <div className="p-4 bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 flex items-start space-x-3">
                      ...
                      <div className="text-left">
                        <h3 className="font-medium text-gray-800 dark:text-white">Upload Documents</h3>
                        <p className="text-sm text-gray-600 dark:text-gray-300">Upload PDF and PowerPoint files to extract and analyze content.</p>
                      </div>
                    </div>
                    ...
                    <div className="p-4 bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 flex items-start space-x-3">
                      ...
                      <div className="text-left">
                        <h3 className="font-medium text-gray-800 dark:text-white">Create Notes</h3>
                        <p className="text-sm text-gray-600 dark:text-gray-300">Organize your thoughts in notebooks with rich text editing.</p>
                      </div>
                    </div>
                    ...
                    <div className="p-4 bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 flex items-start space-x-3">
                      ...
                      <div className="text-left">
                        <h3 className="font-medium text-gray-800 dark:text-white">AI-Powered Analysis</h3>
                        <p className="text-sm text-gray-600 dark:text-gray-300">Ask questions about your documents and get intelligent insights.</p>
                      </div>
                    </div>
                  </div>
                </div>
